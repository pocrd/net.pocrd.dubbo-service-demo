...
import com.pocrd.dubbo_demo.api.CRUDServiceHttpExport;
...
import com.pocrd.dubbo_demo.dao.autogen.entity.ProductDTO;
import com.pocrd.dubbo_demo.dao.autogen.entity.OrderDTO;
import com.pocrd.dubbo_demo.dao.autogen.mapper.UserDTOMapper;
import com.pocrd.dubbo_demo.dao.autogen.mapper.ProductDTOMapper;
import com.pocrd.dubbo_demo.dao.autogen.mapper.OrderDTOMapper;
...
public class CRUDServiceHttpExportImpl implements CRUDServiceHttpExport {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CRUDServiceHttpExportImpl.class);
    ...
    public Product createProduct(Product product) {
        ...
        productDTO.setPrice(new BigDecimal(product.price()==null?"0":product.price().toString()));
    ...
    public Product updateProduct(Product product) {
        ...
        return new Product(
            ...
            updatedProductDTO.getPrice().intValue(),
    ...
    public List<Product> getAllProducts() {
        ...
        productDTOs.forEach(productDTO -> {
            logger.info("商品名称: {}", productDTO.getProductName());
        });
    ...
    public Order createOrder(Order order) {
        ...
        orderDTO.setAmount(new BigDecimal(order.amount()==null?"0":String.valueOf(order.amount())));
        orderDTO.setStatus(order.status()==null?(byte)0:order.status().byteValue());
        ...
        return new Order(
            ...
            orderDTO.getOrderNo(),
            orderDTO.getUserId(),
            orderDTO.getAmount().intValue(),
            orderDTO.getStatus().intValue(),
            orderDTO.getRemark()
        );
    }
    ...
    public Order updateOrder(Order order) {
        ...
        return new Order(
            ...
            updatedOrderDTO.getAmount().intValue(),
            updatedOrderDTO.getStatus().intValue(),
